...
import jackhe.cloud.consumer.feign.fallBack.JackHeUserFeignFallBack;
 ...
 *
 */
@FeignClient(value="jackhe-cloud-user-service",fallback=JackHeUserFeignFallBack.class)
public interface JackHeUserFeign {
