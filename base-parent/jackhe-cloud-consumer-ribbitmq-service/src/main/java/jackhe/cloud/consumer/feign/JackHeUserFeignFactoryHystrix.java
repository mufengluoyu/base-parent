...
import jackhe.cloud.consumer.feign.fallBack.JackHeUserFeignFactoryFallBack;
 ...
 * @FeignClient 用于发现调用的微服务，以及创建负载均衡器，   value为Eureka注册的服务名，fallback为调用不同的回退函数
 * @author hechangzhi 2017年11月14日
 *
 */
@FeignClient(value="jackhe-cloud-user-service",fallbackFactory=JackHeUserFeignFactoryFallBack.class)
public interface JackHeUserFeignFactoryHystrix {
